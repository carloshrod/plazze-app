...
export const TrendingSitesSection = () => {
  // Por ahora usamos los mock sites, pero esto debería venir de una API con los más buscados
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="flex items-center justify-center aspect-[4/3]">
            <Link
              href="/sitios"
              className="text-primary hover:text-primary/80 font-semibold transition-colors group flex items-center hover:bg-primary/10 px-4 py-2 rounded-md"
            >
              Ir a todos los plazzes
